...
export const STORAGE_KEY = 'dairy_mgmt_state_v1';
...
// Format currency
export const formatCurrency = (val) => new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(val || 0);
export const formatDate = (date) => new Date(date).toLocaleDateString('en-IN');

// Calculate milk amount
export const calculateMilkAmount = (qty, fat, snf, rateType, rates, type) => {
...
export const calculateFarmerBalances = (farmers, milkEntries, payments) => {
...
export const getPendingRecordsCount = (state) => {
